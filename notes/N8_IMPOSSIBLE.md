...
`n8_216.json`. nfrag after 3 z-slabs = **26 104 800** = 12 × 2 175 400 (val).
Labels at T=0.3: 3 860 788.

Target 2 Gvox/s is 1080 ms. This run is **12.5×** that, on a faster card than
...
- **W5.** Val identity, **1.63×** vs algo 0 (967 → 594 ms). Default left at 0:
...
- **Dirty hash.** Parent-identical vs G15. Warp+SM **1.31× slower** (158 vs
  120 ms). Full-dirty CUB RBK **4.2× slower** (499 ms). G15 CAS stays. Hash
...
Val 959–1154 ms is 0.16–0.19 Gvox/s. 2 Gvox/s is a 10–12× if time ∝ voxels.
