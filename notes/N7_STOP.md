...
the O(n) dirty scan. Splice cannot deliver the credited 3.86×.
...
N0 credited compact → `227 × 0.259 = 59 ms`. Measured GPU compact stays 227.
...
- MultiMerge / StarMerge / G2 already spent (E2 3.86× visits, G2 1.15× wall,
  E6t slower + non-deterministic).

## N7 gate

need_x without N4 was 1.96 on a 1150 ms IOU. That IOU is false.
Best legal leftover (ε=0.40) is still 1.04×.
