...
|---|---|---|---|---|---|---|
| 0 | 477.6 (cold) | 0.4408 | 0.2543 | PASS | PASS | 1.00x |
| 2 | 248.6 | 0.4421 | 0.2537 | PASS | PASS | 1.92x vs cold |
| 4 | 231.6 | 0.4460 | **0.2653** | FAIL | PASS |: |
| 8 | 219.7 | 0.4408 | 0.2543 | PASS | PASS | same trajectory as k=0 |

Warm nsys val agg was **211 ms**. k=2/8 are not a 1.2x cut vs that. Do **not** default `WATERZ_COMPACT_EVERY`. Keep the env lever. k=4 T=0.3 merge over limit.
