...
- mirrored-tile nfrag = val; concat nfrag = 2 × val
- concat tile0 == val and tile1 == mir, up to id remap
- every cross-seam face has aff 0 → T=0.3 cannot merge across tiles

The official 3×2×2 volume is 12 merge-independent val-sized problems.
That is not a 12× throughput claim.

## P1b FAIL for 1×-val + stamp
...
Halo repair is dead. make_big 3×2×2 uses all 8 flip triples (z=0 and z=2
...
- 8 × val G15 e2e 958.70 ms = **7669 ms** on the 5090
- bandwidth-scaled to 3090 Ti: **13635 ms** (12.6× the 1080 ms budget)
- fused honest stack remains **1642 ms / 1.52×**
- 8-tile serial is **8.3× slower** than fused
...
real face hists are VOI-legal. Serial BinQueue. Not a fused-agg 1.96× cut.
Class closed.
