...
Killed this round: STITCH_ARENA (leak, 1.00×), PIN_CHANGED (1029 s WS), SORT_PACK (slower), FUSE_PACK (1.008×), T8 sticky (N15 four-T FAIL), T10 graph (D2H), T13 drop vcount (BFS qsz).
