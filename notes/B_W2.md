...
The 7–11× quote is Affinity/SCCsim GBBS vs clustered-graph. It is **not** a ParHAC work factor. E2 CSR already is MultiMerge (3.86×, parent-identical). Layer 0 is ~20 660 merges/outer — not the ε=0.01 “few vertices” regime. GPU StarMerge v2 is not started. Keep N6 on agglomeration work.
